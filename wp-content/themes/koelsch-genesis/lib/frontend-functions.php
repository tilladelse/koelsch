 ...
 */
 ...
 /*
  * Deregister Genesis stuff we won't use
  */
 ...
 add_action( 'wp_enqueue_scripts', 'koelsch_dequeue_skip_links' );
 /**
  * Dequeues Skip Links Script.
  *
  * @since 1.0.0
  */
 function koelsch_dequeue_skip_links() {
 ...
 * Header & footer
  */
 add_action( 'genesis_header', 'koelsch_header_markup_open', 5 );
 add_action( 'genesis_header', 'koelsch_header_markup_close', 15 );
 add_action( 'genesis_header', 'koelsch_do_header' );
 add_action( 'genesis_footer', 'koelsch_footer_markup_open', 5 );
 add_action( 'genesis_footer', 'koelsch_footer_markup_close', 15 );
 add_action( 'genesis_footer', 'koelsch_do_footer' );
 // add_action('genesis')


  add_filter('genesis_attr_site-container', function($atts){
    $atts['id'] = 'wrapper';
    return $atts;
  });
  ...
  add_filter('genesis_attr_site-footer', function($atts){
    $atts['id'] = 'footer';
    return $atts;
  });
  ...
  function add_community_header_class($atts){
    $atts['class'] = 'community';
    return $atts;
  }
