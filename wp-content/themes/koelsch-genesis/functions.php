 ...
 */
 ...
 function koelsch_enqueue_scripts_styles() {
 	...
 	// );
	wp_enqueue_script(
		genesis_get_theme_handle() . '-theme',
		get_stylesheet_directory_uri() . '/assets/js/theme.min.js',
		[],
		genesis_get_theme_version()
	);
  wp_enqueue_script('ion-icons','https://unpkg.com/ionicons@5.1.2/dist/ionicons/ionicons.js',[],genesis_get_theme_version());
  wp_enqueue_style('adobe-fonts','https://use.typekit.net/sfc3cfe.css',[],genesis_get_theme_version());
